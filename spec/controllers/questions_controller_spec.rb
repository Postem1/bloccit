...
RSpec.describe QuestionsController, type: :controller do
  let(:my_question) {Question.create!(title: "New Question title", body: "New Question body", resolved: RandomData.random_boolean)}
  ...
  describe "POST create" do
    ...
    expect{post :create, question: {title: RandomData.random_question, body: RandomData.random_paragraph, resolved: RandomData.random_boolean}}.to change(Question,:count).by(1)
    end

    it "assigns the new question to @question" do
    post :create, question: {title: RandomData.random_question, body: RandomData.random_paragraph, resolved: RandomData.random_boolean}
